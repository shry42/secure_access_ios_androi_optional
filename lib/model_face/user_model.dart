class UserModel {
  ...
  String? registeredOn;
  // String? updatedOn; // Add this line
  String? docId;
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      // updatedOn: json['updatedOn'], // Add this line
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      // 'updatedOn': updatedOn, // Add this line
    };
  }
}

//For UPDATE ON FILED//////
class UserModelUpdatedOne {
  String? id;
  String? name;
  String? image;
  FaceFeatures? faceFeatures;
  ...
  factory UserModelUpdatedOne.fromJson(Map<String, dynamic> json) {
    return UserModelUpdatedOne(
      id: json['id'],
      name: json['name'],
      image: json['image'],
      faceFeatures: FaceFeatures.fromJson(json["faceFeatures"]),
